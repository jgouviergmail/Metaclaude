...
export const fr: Record<string, string> = {
  ...
  'What the memory gate made of each note this run proposed. A refused note can still be kept.': 'Ce que le filtre mémoire a fait de chaque note proposée par ce run. Une note écartée peut encore être gardée.',
  'standing': 'convention',
  'volatile': 'volatile',
  durable: 'durable',
